...
export const PASOS = [
  { ord: '01', titulo: 'Se mide, no se supone.', texto: 'Sueño, recuperación y estrés leídos desde tu mano, todos los días. Basta una noche de mal sueño para que tu cerebro procese el riesgo de forma distinta.', img: '/landing/wearable.png', alt: 'Wearable en la mano' },
  ...
  { ord: '03', titulo: 'Todo cruzado en un solo lugar.', texto: 'Tu estado real, en una plataforma de bienestar con IA en la que puedes decidir con datos, no con sensaciones.', img: '/landing/dashboard-preview.png', alt: 'Vista previa del tablero Evolution' },
] as const;
...
export const JUNTA_PUNTOS: JuntaPunto[] = [
  {
    ...
    pie: '12 directivos, misma cohorte. 2 se apartan del patrón.',
    chart: 'cohorte',
  ...
  },
  {
    ...
    pie: 'Agregado por cohorte sube al acta. El dato médico–paciente individual, nunca.',
    chart: 'barras',
    filas: [
