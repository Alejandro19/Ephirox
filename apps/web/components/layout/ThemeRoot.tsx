...
const NO_FLASH_SCRIPT = `(function(){try{
  ...
  var modules=['/onboarding','/training','/nutrition','/cortisol','/rest','/blindspot','/community','/evolution'];
  var isModule=modules.some(function(base){return path===base||path.indexOf(base+'/')===0;});
