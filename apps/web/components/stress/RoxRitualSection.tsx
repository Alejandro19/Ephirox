...
// Stress existente (decisión confirmada) — son técnicas reales, creadas
// por el admin con isRitual=true, no un sistema paralelo. "Iniciar" abre el
// mismo reproductor (StressPlayer) que el resto de las técnicas.
export function RoxRitualSection({ rituals, onStart }: { rituals: StressTechnique[]; onStart: (id: string) => void }) {
