...
import { listTips, createTip, deleteTip, updateTip, type StressTip } from '../../lib/stress-tips-client';
...
export function StressTipsPanel() {
  const [tips, setTips] = useState<StressTip[]>([]);
  ...
  function startEdit(tip: StressTip) {
    setEditingId(tip.id);
